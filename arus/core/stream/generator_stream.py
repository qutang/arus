...
class GeneratorSlidingWindowStream(SlidingWindowStream):
    ...
    def __init__(self, data_source, window_size, start_time=None, buffer_size=1800, simulate_reality=False, start_time_col=0, stop_time_col=0, name='generator-stream'):
        """
        Args:
