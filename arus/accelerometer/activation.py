...
def stats_active_samples(X, threshold=0.2):
    ...
    names_num_active_samples = ['ACTIVE_SAMPLES_' +
                                str(i) for i in range(stats_num_active_samples.shape[1])]
    """
    ...
    names_num_activations = ['ACTIVATIONS_' +
                             str(i) for i in range(stats_num_activations.shape[1])]
    """
    ...
    names_mean_activation_durations = ['MEAN_ACTIVATION_DURATIONS_' +
                                       str(i) for i in range(stats_mean_activation_durations.shape[1])]
    """
    ...
    names_std_activation_durations = ['STD_ACTIVATION_DURATIONS_' +
                                      str(i) for i in range(stats_std_activation_durations.shape[1])]
    ...
    names = names_num_active_samples + names_num_activations + \
        names_mean_activation_durations + names_std_activation_durations
    return result, names
